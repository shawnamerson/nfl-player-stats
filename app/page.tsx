        ...
        <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm text-zinc-300">
              ...
              and judge picks with opponent context.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 text-xs text-zinc-400">
              <span>Fast charts</span> <span>•</span>{" "}
              <span>Hit-rate overlays</span> <span>•</span>{" "}
        ...
        <div className="surface p-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              [
                "Set a prop line",
                "Toggle stat charts and add your line; hits are highlighted.",
              ],
              [
                "Decide with context",
                "Hit-rate + defense strength guide your pick.",
              ],
            ].map(([t, b], i) => (
              <div
                key={t}
